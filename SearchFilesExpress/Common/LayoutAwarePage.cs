...
namespace SearchFiles.Common
{
    ...
    public class LayoutAwarePage : Page
    {
        ...
        public static AppViewState GetViewState()
        {
            AppViewState viewState = AppViewState.FullScreenLandscape;
            var windowWidth = Window.Current.Bounds.Width;
            var windowHeight = Window.Current.Bounds.Height;
            ...
            else if (windowWidth < 1366)
            {
                if (windowWidth < windowHeight)
                {
                    viewState = AppViewState.FullScreenPortrait;
                }
                else
                {
                    viewState = AppViewState.Filled;
                }
            }
            return viewState;
        }
    ...
    {
        // Summary:
        //     The current app's view is in full-screen (has no snapped app adjacent to
        //     it), and has changed to landscape orientation.
        FullScreenLandscape = 0,

        // Summary:
        //     The current app's view has been reduced to a partial screen view as the result
        //     of another app snapping.
        Filled = 1,
        ...
        // Summary:
        //     The current app's view is in full-screen (has no snapped app adjacent to
        //     it), and has changed to portrait orientation.
